  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center">
      ...
      <div className='relative w-screen h-[20vh]'>
        ...
        <div className='absolute bottom-[-25px] w-screen'>
      ...
      <div className='relative w-screen h-[80vh]'>
        <div className='grid grid-flow-col gap-5 px-5 mt-10'>
          <div className='category'>
            <div className="category-card mb-5">
              ...
              <h4 className='text-base font-semibold tracking-wide'>Burger</h4>
            </div>
            <div className="category-card mb-5">
              <div className='relative w-[50px] h-[50px]'>
                <Image
          ...
          <div className="product">
            <div className="w-fit bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl mb-5">
              <a href="#">
                <img src="https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="Product" className="h-30 w-72 object-cover rounded-t-xl" />
            ...
            <div className="w-fit bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
              <a href="#">
                <img src="https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="Product" className="h-30 w-72 object-cover rounded-t-xl" />
                <div className="px-4 py-3">
                  <span className="text-gray-400 mr-3 uppercase text-xs">Brand</span>
